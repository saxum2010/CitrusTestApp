...
function showViewedProducts(datas, products_name){
	...
	$.each(datas.viewedItems, function(key,value){
		...
		output += '<li class=""><a data-transition="slide" product_id="'+value.id+'" data-ajax=false onclick="alert('+url+');changePage('+url+');" link="'+url+'"><table style="width:100%"><tr><td style="vertical-align: middle;text-align:center;width:64px" class="first"><img src="' + value.image + '" ></td><td style="vertical-align:middle;text-align:left;padding-left:1.1rem;"><div class="box_catalog_status">'+text_flag+' </div><h2 class="item_name_only product">' + value.name + '</h2>'+row2+'<div class="props">'+prop+payment_parts+'</div></td><td style="width:25px"></td></tr></table></a></li>';
	});
