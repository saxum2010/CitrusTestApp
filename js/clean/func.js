							...
							if(json.bundle.bundle !== undefined){
								$.each(json.bundle.bundle, function( key, bundle_item ) {
									if(bundle_item!=null){
										...
										output += '<li><a data-transition="slide" data-ajax=false bundle_id="'+bundle_item.id+'" class="vclick_bundle"><div><div class="bundle_price">'+bundle_item.old_price_print+'</div></div><div class="bundle_price">'+bundle_item.price_print+' грн</div><table style="width:100%"><tr><td class="first aligntab64"><div class="bundle_item"><img src="'+ json.bundle.main.image + '"><br /><span class="bundle_price">'+json.bundle.main.price_print+'грн</span></div></td><td class="aligntab64 bundle_plus">+</td><td class="aligntab64"><div class="bundle_item">'+diskount_block+'<img src="'+ bundle_item.image + '"><br /></div></td><td width="10"></td></tr></table></a></li>';
									}
								});
							}
